...
<nav class="bg-[#13293D] px-6 py-4 shadow-md fixed w-full top-0 z-50">
    <div class="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <ul class="flex space-x-6 text-black">
            ...
            <li><a href="/tokotani" class="hover:text-green-500">TOKOTANI</a></li>
            <li><a href="/team" class="hover:text-green-500">TEAM</a></li>
            @if (Route::has('login'))
                @auth
                    <li><a href="{{ url('/dashboard') }}" class="hover:text-green-500">DASHBOARD</a></li>
                @else
        ...
        <div class="bg-white rounded-lg shadow-lg p-10 flex  lg:flex-row items-center lg:items-start gap-10 w-full h-full ">
            ...
            <div class="w-full lg:w-2/3 text-center lg:text-left">
                ...
                <p class="text-gray-700">
                    Melalui TaniSmart, kami berkomitmen untuk memberdayakan petani Indonesia dengan teknologi, 
                    membantu mereka meningkatkan efisiensi, mengoptimalkan hasil panen, dan menciptakan pertanian yang berkelanjutan.
                </p>
            </div>
        </div>
    </div>
